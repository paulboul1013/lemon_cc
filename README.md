...
以下是一份 **HackMD 風格的完整技術筆記**，我依照 **《Writing a C Compiler – Chapter 6: If Statements and Conditional Expressions》** 的結構重新整理。
內容包含：
...
並補充一些 **編譯器設計理解**，幫助你確保是真的吸收知識。

（內容基於書與作者原始教學文章） ([Nora Sandler][1])

---


## Writing a C Compiler — Chapter 6
